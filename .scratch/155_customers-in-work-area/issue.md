# 155 — Customers open in the work area; pages carry their own back caret

Status: done
Labels: ready-for-agent

ADR: docs/adr/0047-rail-drawers.md (amendment 2026-09-24)
Proof: proof/*.png (rail-preview.html harness)

The Customers browser opens in the work area like the Apps, instead of a
