  ...
  return (
    <aside style={{ width: 248 }} className="ft-rail border-r border-slate-200 flex flex-col shrink-0 h-full">
      ...
      <div className="p-2.5 space-y-2">
        ...
        <button className="w-full flex items-center justify-center gap-1.5 rounded-md border border-slate-200 hover:bg-slate-50 text-sm font-semibold py-1.5 text-slate-600">
          <Folder size={15} className="text-indigo-500" /> Customers
          <span className="text-[10px] font-semibold text-slate-400 bg-slate-100 rounded-full px-1.5 leading-5">3</span>
        </button>
        <div className="flex gap-2">
          <button title="wedi shower configurator" className="flex-1 flex items-center justify-center gap-1.5 rounded-md border border-slate-200 hover:bg-slate-50 text-sm font-semibold py-1.5 text-slate-600"><ShowerHead size={15} /> wedi</button>
          <button title="Sheoga hardwood configurator" className="flex-1 flex items-center justify-center gap-1.5 rounded-md border border-slate-200 hover:bg-slate-50 text-sm font-semibold py-1.5 text-slate-600"><TreePine size={15} /> Sheoga</button>
        </div>
      </div>
