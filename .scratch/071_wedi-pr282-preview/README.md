...
| `I1-58x33-deep-cut-options` | **Owner round 3 — the 6″ cut rule is SOFT.** The 58×33 repro again: the 36×72 offset base now lands the drain EXACTLY at 6″, 16½″ by cutting 7¾″ off a side — badged "Deep cut", warning stating the amount (the offset bases are designed to cut up to a foot to meet a waste line) — with the shallow "Closest fit" card riding along ("shallow alternative") so the salesman chooses. Cuts stay ≤6″ without comment, ≤12″ ceiling; the kit and drawings carry the cut (`Cut US9100005 to 58″ × 33″`). |
