...
const head = await page.evaluate(() => { const paper = document.querySelector(".ft-paper"); return Math.round(paper.querySelector(".ft-pband").getBoundingClientRect().top - paper.getBoundingClientRect().top); });
