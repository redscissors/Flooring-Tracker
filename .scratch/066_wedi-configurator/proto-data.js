// wedi prototype data — GENERATED from WEDI_1.xlsx (ERP Vendor SKU Analysis)
// and USA_wedi_Distribution_Pricelist_JAN_1_2026.xlsx (wedi Fundo sheet).
// stock: {erp, desc, cost, retail, unit, us}. so: {us, name, size, details, retail, net, section, discount, erp} (+ {kitNote, section} rows).
const WEDI_STOCK = [
 {
  "erp": "1518658",
