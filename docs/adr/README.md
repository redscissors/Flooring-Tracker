...
| [0036](0036-wedi-stock-side-registry-driven.md) | wedi's stock side is registry-driven, not transcribed: `WEDI_STOCK` stays as a gated, visible fallback until the pricelist half (8b) moves too | Accepted | 2026-09-01 |
