        ...
        {onFlip && (
          <button type="button" onClick={onFlip} title={tip} aria-label={tip}
            ...
            <svg width="7" height="192" viewBox="0 0 7 192" className="block" style={left ? { transform: "scaleX(-1)" } : undefined} aria-hidden="true">
              <path d="M7 0 C7 11 0.5 9 0.5 20 L0.5 172 C0.5 183 7 181 7 192 Z" fill="var(--ft-card)" />
              <path d="M7 0 C7 11 0.5 9 0.5 20 L0.5 172 C0.5 183 7 181 7 192" fill="none" stroke="var(--ft-border)" strokeWidth="1" />
