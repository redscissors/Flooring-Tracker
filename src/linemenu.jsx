...
export function LineMenu({ menu, title, subtitle, areas, canDelete, sampleOn, hasNote, wasteText, onClose, onDuplicate, onMoveTo, onSample, onNote, onWaste, onFlag, onDelete }) {
