...
test("normalizeSettings attaches pricing defaults and keeps stored values", () => {
  assert.deepEqual(normalizeSettings().pricing, { builderPct: 8, salePct: 10, sheogaMarkupPct: 40, sheogaVentMarkupPct: 50 });
  const s = normalizeSettings({ pricing: { builderPct: 12, salePct: 25, sheogaMarkupPct: 55, sheogaVentMarkupPct: 65 } });
  assert.deepEqual(s.pricing, { builderPct: 12, salePct: 25, sheogaMarkupPct: 55, sheogaVentMarkupPct: 65 });
});
