...
const TABLE = [
  ...
  ["PC·CT no SF/CT — bullnose carton with no coverage → count line, per-piece price, carton rounding (CDSTABABN240R)",
    { type: "tile", priceUnit: "PC", orderUnit: "CT", cost: 56.89, pcPerUnit: 10 },
    { type: "misc", priceSqft: "56.89", cartonPc: "10", cartonUnit: "CT" }],
  ...
  ["ST·CT no SF/CT — sticks sold by the carton → count line, per-stick price, carton rounding",
    { type: "tile", priceUnit: "ST", orderUnit: "CT", cost: 22.14, pcPerUnit: 6 },
    { type: "misc", priceSqft: "22.14", cartonPc: "6", cartonUnit: "CT" }],
  ["PC·CT +SF/CT trim — reclassified bullnose: per-piece count line, carton rounding, SF/CT ignored (ADR 0013 amendment)",
    { type: null, trim: true, priceUnit: "PC", orderUnit: "CT", cost: 27.99, sfPerUnit: 5.38, pcPerUnit: 8 },
    { type: "misc", priceSqft: "27.99", cartonPc: "8", cartonUnit: "CT", cartonSf: undefined }],
  ["PC·PC trim +bogus SF/CT — end cap sold loose, fabricated coverage ignored (ADXNEBLBASE12EDS)",
    { type: null, trim: true, priceUnit: "PC", orderUnit: "PC", cost: 23.89, sfPerUnit: 121.1, pcPerUnit: 45 },
    { type: "misc", priceSqft: "23.89", cartonPc: undefined, cartonSf: undefined }],
  ["SF·RL +SF/CT — membrane roll priced per sqft, sold whole rolls (Schluter EFT SLRDH512M): count line at the WHOLE-ROLL price, $1.74 × 134.5 sf",
    { type: null, priceUnit: "SF", orderUnit: "RL", cost: 1.74, sfPerUnit: 134.5 },
    { type: "misc", priceSqft: "234.03", sellUnit: "RL" }],
  ["SF·SH +SF/CT untyped — membrane sheet priced per sqft (SLRDHDPS8MA): count line at the whole-sheet price, $3.27 × 8.3958 sf",
    { type: null, priceUnit: "SF", orderUnit: "SH", cost: 3.27, sfPerUnit: 8.3958 },
    { type: "misc", priceSqft: "27.45", sellUnit: "SH" }],
  ["SH·SH untyped + oversized per-sheet coverage — membrane sheet priced per its own sheet (SLRDH5MA): the sheet price as-is",
    { type: null, priceUnit: "SH", orderUnit: "SH", cost: 15.22, sfPerUnit: 8.4 },
    { type: "misc", priceSqft: "15.22", sellUnit: "SH" }],
  ...
  ["SF single-U/M + SF/CT — the one U/M column is the PRICE basis, so nothing names the bundle (F14CATCIV0312P): coverage counts cartons, never \"SF/SF\"",
    { type: "tile", unit: "SF", cost: 3.47, sfPerUnit: 12.15 },
    { type: "tile", priceSqft: "3.47", cartonSf: "12.15", cartonUnit: "CT" }],
